...
func (e *Error) Error() string {
	...
	case e.Node != nil:
		...
		return fmt.Sprintf("github.com/gofabrik/t/html/template:%s: %s", loc, e.Description)
	case e.Line != 0:
		return fmt.Sprintf("github.com/gofabrik/t/html/template:%s:%d: %s", e.Name, e.Line, e.Description)
	case e.Name != "":
		return fmt.Sprintf("github.com/gofabrik/t/html/template:%s: %s", e.Name, e.Description)
	}
	return "github.com/gofabrik/t/html/template: " + e.Description
}
